...
Write-Host "Tauri Desktop App Build Tool (SQLite + Shutdown)" -ForegroundColor Cyan
Write-Host "===================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "===================================" -ForegroundColor Cyan
Write-Host "Building Tauri (SQLite + Shutdown)" -ForegroundColor Cyan
Write-Host "===================================" -ForegroundColor Cyan
Write-Host ""
...
# Copy shutdown version to main.rs
...
try {
    if ($DevMode) {
        ...
        Write-Host "Build Completed (SQLite + Shutdown)" -ForegroundColor Green
        Write-Host "===================================" -ForegroundColor Green
        Write-Host ""
...
Write-Host ""
Write-Host "Done! (SQLite + Shutdown version)" -ForegroundColor Green